...
void    IN_A_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the IN_A_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(IN_A__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in IN_A_SetInterruptMode() function.
     *  @{
     */
        #define IN_A_INTR_NONE      (uint16)(0x0000u)
        #define IN_A_INTR_RISING    (uint16)(0x0001u)
        #define IN_A_INTR_FALLING   (uint16)(0x0002u)
        #define IN_A_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define IN_A_INTR_MASK      (0x01u) 
#endif /* (IN_A__INTSTAT) */
...
/* SIO registers */
#if defined(IN_A__SIO_CFG)
    #define IN_A_SIO_HYST_EN        (* (reg8 *) IN_A__SIO_HYST_EN)
    #define IN_A_SIO_REG_HIFREQ     (* (reg8 *) IN_A__SIO_REG_HIFREQ)
    #define IN_A_SIO_CFG            (* (reg8 *) IN_A__SIO_CFG)
    #define IN_A_SIO_DIFF           (* (reg8 *) IN_A__SIO_DIFF)
#endif /* (IN_A__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define IN_A_0_INTTYPE_REG 		(* (reg8 *) IN_A__0__INTTYPE)
#endif /* (IN_A__INTSTAT) */
