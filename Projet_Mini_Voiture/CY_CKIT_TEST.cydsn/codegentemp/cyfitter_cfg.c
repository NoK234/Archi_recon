...
#define BS_UDB_0_5_1_CONFIG_VAL ((const uint8 CYFAR *)0x48000494u)
...
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x48000534u)
...
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x48000544u)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG1_CFG0), 0x063Fu);
